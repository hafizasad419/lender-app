...
import { collectorSignup } from './api';
import { useNavigate } from "react-router-dom"

const CollectorForm = ({ setUserDetails }: any) => {
            ...
            {(form) => (
                ...
                <Form className="space-y-4">
                    ...
                    <p className='text-red-500 font-semibold'>
                        I want to buy debts and earn money.
                    </p>
                    ...
                    <TextField
                        field="organization"
                        label_text="Organization (optional)"
